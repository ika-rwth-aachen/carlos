...
```bash
# carlos/data-driven-development$
python ./data_generation.py --config data-driven-development-demo-scenario-execution.yaml
```
...
3. Start the pipeline with `python ./data_generation.py --config <your-modified-config-file>`.
